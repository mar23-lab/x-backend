...
import {
  authorityReceiptFromBody,
  readStrictAuthorityReplay,
  validateStrictInput,
  type AuthorityStrictInput,
} from './customer-authority-strict';
...
// Strict-idempotency CLAIM helpers live in ./customer-authority-strict (extracted 260803).
