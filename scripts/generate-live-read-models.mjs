  ...
  const routes = [
    {
      ...
      allowed_repos: ['MB-P', 'x-backend', 'xcp-platform'],
    ...
    },
    {
      ...
      allowed_repos: ['x-backend', 'xcp-platform'],
    ...
    },
    {
      ...
      invocation_surfaces: ['chat', 'command', 'session_routing'],
      allowed_repos: ['MB-P', 'x-backend', 'xcp-platform', 'x-ai-docs', 'x-ai-front'],
    ...
    },
    {
      ...
      allowed_repos: ['xcp-platform', 'x-backend'],
...
function buildCrossSessionHandoff() {
  return {
    ...
    generated_at: GENERATED_AT,
    valid_until: VALID_UNTIL,
    mutation_boundary: 'x-backend only',
    targets: [
      ['mb-p-governance', 'Registry retains xlooop-xcp-demo-B only as a stable historical adapter key while x-backend is the active runtime consumer.', 'completed'],
      ...
      ['x-ai-front', 'Own customer-product and public-web source surfaces.', 'active'],
      ['x-ai-docs', 'Provide governed public-safe business and product documentation for runtime projections.', 'active'],
